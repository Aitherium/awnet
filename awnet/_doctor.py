...
interesting failures live BETWEEN them. "awnet is installed" is not the useful
fact -- "awnet is installed and the thing it pairs with is not" is. This reports
...
SELF = 'awnet'
FAMILY = ['awask', 'awask', 'awbac', 'awbrowse', 'awdit', 'awevolve', 'awevolve', 'awfind', 'awgit', 'awgraph', 'awiam', 'awkno', 'awm', 'awmail', 'awnboard', 'awnest', 'awnode', 'awpredict', 'awprism', 'awreason', 'awrecover', 'awrecurse', 'awrelay', 'awrepl', 'awresearch', 'awrun', 'awseal', 'awshare', 'awtunnel']
PAIRS_WITH = ['adk', 'awnode', 'awrelay']
...
def _local_checks() -> "list[str]":
    ...
    from the registry, but it does not know what awnet needs at runtime, and a
